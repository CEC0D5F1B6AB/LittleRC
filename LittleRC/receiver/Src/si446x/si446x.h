...
#define	RECV_LENGTH 6

#define SEND_CHANNEL 0
#define RECV_CHANNEL 0

#define SI_CSN_LOW()   HAL_GPIO_WritePin(SI_CSN_GPIO_Port, SI_CSN_Pin, GPIO_PIN_RESET)
#define SI_CSN_HIGH()  HAL_GPIO_WritePin(SI_CSN_GPIO_Port, SI_CSN_Pin, GPIO_PIN_SET)

#define SI_SDN_LOW()   HAL_GPIO_WritePin(SI_SDN_GPIO_Port, SI_SDN_Pin, GPIO_PIN_RESET)
#define SI_SDN_HIGH()  HAL_GPIO_WritePin(SI_SDN_GPIO_Port, SI_SDN_Pin, GPIO_PIN_SET)
